    ...
    <div className={`py-4 min-h-screen ${styles.section}`}>
      ...
      {open && (
        <div className="w-ful fixed top-0 left-0 h-screen bg-[#0005] z-50 flex items-center justify-center">
          <div className="w-[50%] h-min bg-slate-50 shadow rounded-md p-3">
            ...
            <div className="w-full ml-3">
              ...
              <textarea
                ...
                placeholder="How was your product? write your exprience about it"
                className="ml-1 w-[95%]] border p-2 outline-none "
              ></textarea>
            </div>
            <div
